...
def get_user_from_cr(vk, name, day, month, year):
...
def print_into(vk, originals, inf, text):
    ...
    for cr in credentials:
        user = get_user_from_cr(vk, cr['name'], *cr['bday'])
        if user:
...
if __name__ == '__main__':
    ...
    print_into(vk, originals=True, inf=True, text="Пред. абитуриенты (Оригинал+Информатика)")
    print_into(vk, originals=True, inf=False, text="Пред. абитуриенты (Оригинал)")
    # print_into(vk, originals=False, inf=True, text="Пред. абитуриенты (ОК+Информатика)")
    # print_into(vk, originals=False, inf=False, text="Пред. абитуриенты (ОК)")
